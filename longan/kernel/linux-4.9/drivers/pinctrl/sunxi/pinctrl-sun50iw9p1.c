...
static const struct sunxi_desc_pin sun50iw9p1_pins[] = {
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(B, 23),             /* BCLK */
		SUNXI_FUNCTION(0x2, "h_pcm0"),
		SUNXI_FUNCTION(0x4, "h_pcm2"),
		SUNXI_FUNCTION(0x5, "h_pcm3"),
		SUNXI_FUNCTION(0x7, "io_disabled")),
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(F, 0),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 3, 0),  /*  PF_EINT0  */
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(F, 1),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 3, 1),  /*  PF_EINT1  */
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(F, 2),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 3, 2),  /*  PF_EINT2  */
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(F, 3),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 3, 3),  /*  PF_EINT3  */
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(F, 4),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 3, 4),  /*  PF_EINT4  */
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(F, 5),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 3, 5),  /*  PF_EINT5  */
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(F, 6),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "jtag"),		/* SEL */
		SUNXI_FUNCTION_IRQ_BANK(0x6, 3, 6),  /*  PF_EINT6  */
		SUNXI_FUNCTION(0x7, "io_disabled")),
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 0),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 0),  /*  PG_EINT0  */
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 1),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "sdc1"),		/* CMD */
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 1),  /*  PG_EINT1	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 2),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "sdc1"),		/* D0 */
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 2),  /*  PG_EINT2	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 3),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "sdc1"),		/* D1 */
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 3),  /*  PG_EINT3	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 5),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 5),  /*  PG_EINT5	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 6),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "uart1"),  /* TX */
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 6),  /*  PG_EINT6	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 7),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "uart1"),		/* RX */
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 7),  /*  PG_EINT7	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 8),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 8),  /*  PG_EINT8	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 9),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 9),  /*  PG_EINT9	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 10),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 10),  /*  PG_EINT10	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 11),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 11),  /*  PG_EINT11	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 12),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 12),  /*  PG_EINT12	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 13),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 13),  /*  PG_EINT13	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 14),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 14),  /*  PG_EINT14	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 15),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 15),  /*  PG_EINT15	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 16),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 16),  /*  PG_EINT16	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 17),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 17),  /*  PG_EINT17	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 18),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 18),  /*  PG_EINT18	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(G, 19),
		...
		SUNXI_FUNCTION_IRQ_BANK(0x6, 4, 19),  /*  PG_EINT19	*/
		SUNXI_FUNCTION(0x7, "io_disabled")),
