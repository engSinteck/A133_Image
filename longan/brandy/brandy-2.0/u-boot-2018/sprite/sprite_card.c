...
static int __download_normal_part(dl_one_part_info *part_info,
				  uchar *source_buff);
extern int sunxi_sprite_mmc_phyerase(unsigned int start_block,
				     unsigned int nblock, void *skip);
extern int sunxi_sprite_mmc_phywrite(unsigned int start_block,
